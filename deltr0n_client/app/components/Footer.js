        ...
        <div className="grid grid-cols-2 gap-8 px-4 py-6 lg:py-8 md:grid-cols-4">
          <div>
            ...
            <ul className="text-gray-500 dark:text-gray-400 font-medium">
              <li className="mb-4">
                <a href="#" className=" hover:underline">999888777</a>
              </li>
              <li className="mb-4">
                <a href="#" className="hover:underline">ejemplo@pchermanos.com.pe</a>
              </li>
            </ul>
          </div>
          <div>
            ...
            <ul className="text-gray-500 dark:text-gray-400 font-medium">
              <li className="mb-4">
                <a href="#" className="hover:underline">Servidor de Discord</a>
              </li>
              <li className="mb-4">
          ...
          <div>
            ...
            <ul className="text-gray-500 dark:text-gray-400 font-medium">
              ...
              <li className="mb-4">
                <a href="#" className="hover:underline">Políticas y condiciones de uso</a>
              </li>
              <li className="mb-4">
                <a href="#" className="hover:underline">Sugerencias</a>
              </li>
            </ul>
          </div>
          <div>
            ...
            <ul className="text-gray-500 dark:text-gray-400 font-medium">
              ...
              <li className="mb-4">
                <a href="#" className="hover:underline">Comprobantes electrónicos</a>
              </li>
            </ul>
          </div>
        </div>
        <div className="px-4 py-6 md:flex md:items-center md:justify-between">
          <span className="text-sm text-gray-500 dark:text-gray-300 sm:text-center">© 2023 PC Hermanos. All Rights Reserved.
          </span>
